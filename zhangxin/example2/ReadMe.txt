========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : NECTestPattern
========================================================================


AppWizard が生成した NECTestPattern には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには NECTestPattern を構成している各ファイルの概要説明が含まれています。
...
NECTestPattern.h
    ...
    みます） をインクルードし、また CNECTestPatternApp アプリケーションクラスを宣
    言します。

NECTestPattern.cpp
    このファイルは CNECTestPatternApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\NECTestPattern.ico
    このファイルは、アプリケーションのアイコンとして使用されるアイコンファイ
    ルです。このアイコンはリソース ファイル NECTestPattern.rc によってインクルード
    されます。

res\NECTestPattern.rc2
...
NECTestPatternDlg.h, NECTestPatternDlg.cpp - ダイアログ
    これらのファイルは CNECTestPatternDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な NECTestPattern.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) NECTestPattern.pch 
